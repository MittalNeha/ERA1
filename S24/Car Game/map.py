...
Config.set('graphics', 'width', '2082')
Config.set('graphics', 'height', '1151')
...
im = CoreImage("./images/homemapmask.png")
...
class CarApp(App):
    ...
    def build(self):
        Window.size = (int(int(Config.get("graphics", "width"))/2), int(int(Config.get("graphics", "height"))/2))
        parent = Game()
        parent.serve_car()
